...
y_train = []
y_test = []
with open("y_train150_flt.txt", "r") as f:
     for line in f:
            y_train.append(int(line.strip()))
            
with open("y_test150_flt.txt", "r") as f:
     for line in f:
            y_test.append(int(line.strip()))

X_train = np.load("X_train150_flt.npy")
X_test = np.load("X_test150_flt.npy")
...
###### Save Model ######
model.save('inception_v3_flt.h5')
